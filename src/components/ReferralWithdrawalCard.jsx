...
export default function ReferralWithdrawalCard({ profile, referrals, requests, onSubmitted }) {
  ...
  return (
    <>
      ...
      {activeRequest && (
        <Card className="p-5 sm:p-6 mb-6 bg-gradient-to-br from-brand to-brand-dark text-white">
      ...
      <Card className="p-5 sm:p-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-heading font-semibold text-lg text-foreground">
            {activeRequest ? "Withdraw New Referral Earnings" : "Withdraw Your Referral Earnings"}
          </h2>
        </div>
