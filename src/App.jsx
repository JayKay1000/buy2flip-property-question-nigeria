...
// Landing is eager — it's the first page most visitors see (route "/").
// All other pages are code-split into separate chunks so the initial bundle
// stays small and heavy libraries (recharts, jspdf, leaflet, etc.) only load
