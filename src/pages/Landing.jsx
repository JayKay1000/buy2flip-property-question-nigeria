        ...
        <div className="relative z-10 flex-1 flex items-center w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-24 sm:py-32 w-full">
            ...
            <div className="mt-6 max-w-xl animate-fade-up" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="mt-2 text-lg text-white/80 leading-relaxed">"Buy2Flip" Land-Backed Real Estate Opportunity wIth UP TO 65% Guaranteed Returns
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div key={step.step} className="relative">
              ...
              <Card className="relative overflow-hidden h-full min-h-[300px] border-border hover:border-gold/40 transition-colors duration-300 hover:shadow-md">
